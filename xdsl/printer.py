...
class Printer:
    ...
    def print_attribute(self, attribute: Attribute) -> None:
        ...
        # Function types have an alias in MLIR
        ...
        # Dense element types have an alias in MLIR
        ...
        # Dense resources have an alias in MLIR
        ...
        # vector types have an alias in MLIR
        if isinstance(attribute, VectorType | TensorType):
        ...
        # Unranked tensors have an alias in MLIR
        ...
        # memref types have an alias in MLIR
        ...
        # IndexType has an alias in MLIR
        if isinstance(attribute, IndexType):
            self.print("index")
            return

        # opaque attributes have an alias in MLIR
